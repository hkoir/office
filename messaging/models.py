...
class Notification(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, null=True, blank=True,related_name="msg_notify_user")   
    notification_type=models.CharField(max_length=100,choices=[('low-stock','Low stock'),('payment-due','Payment_due'),('notice','Notice'),('general','General')], null=True, blank=True)
